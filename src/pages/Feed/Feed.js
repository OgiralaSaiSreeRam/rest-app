...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch('http://localhost:8001/graphql', {
      ...
      .then(resData => {
        ...
        this.setState({ status: resData.data.user.state });
      })
  ...
  loadPosts = direction => {
    ...
    fetch('http://localhost:8001/graphql',{
      ...
      .then(res => {
        // console.log(res); always gives some cors stuff
        return res.json();
      })
      .then(resData => {
        // console.log(resData);
  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8001/post-image', {
      method: 'PUT',
      headers: {
        Authorization: 'Bearer ' + this.props.token
      },
    ...
    let url = 'http://localhost:8001/graphql';
    let method = 'POST';
